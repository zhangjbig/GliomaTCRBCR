...
mutcodel <- mutcodel[which(mutcodel$len == 13),]
mutcodel_logo <- data.frame(table(mutcodel$CDR3.aa))
write.csv(mutcodel_logo,"/Users/wanglu/Documents/2021_TC/final_version2/length_weblogo/mutcodel_igl_logo.csv",row.names = FALSE ) 
