...
mutnoncodel <- mutnoncodel[which(mutnoncodel$len == 16),]
mutnoncodel_logo <- data.frame(table(mutnoncodel$CDR3.aa))
write.csv(mutnoncodel_logo,"/Users/wanglu/Documents/2021_TC/final_version2/length_weblogo/mutnoncodel_igh_logo.csv",row.names = FALSE ) 
