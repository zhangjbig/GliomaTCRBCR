...
mutcodel <- mutcodel[which(mutcodel$len == 11),]
mutcodel_logo <- data.frame(table(mutcodel$CDR3.aa))
write.csv(mutcodel_logo,"/Users/wanglu/Documents/2021_TC/final_version2/length_weblogo/mutcodel_tra_logo.csv",row.names = FALSE ) 
