...
repeat_line <- data.frame(CDR3.aa = 0,V.name = 0,J.name = 0)
...
write.csv(public,"/Users/wanglu/Documents/2021_TC/final_version2/private_public/private_public_mutnoncodel/mutnoncodel_tra_public.csv",row.names = FALSE )
...
write.csv(private,"/Users/wanglu/Documents/2021_TC/final_version2/private_public/private_public_mutnoncodel/mutnoncodel_tra_private.csv",row.names = FALSE )
