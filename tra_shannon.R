...
write.csv(wt_shdi,"/Users/wanglu/Documents/2021_TC/final_version2/evaluating_indicator/tra_wt_shdi.csv",row.names = FALSE ) 
...
Chain <- Chain[,-1]
Chain <- split(Chain[,-1], Chain$CGGA_ID ) #按照CGGA_ID分类 -1指的是去掉第一列
Chain <- list(Chain)
names(Chain) <- c("data")
...
write.csv(mutcodel_shdi,"/Users/wanglu/Documents/2021_TC/final_version2/evaluating_indicator/tra_mutcodel_shdi.csv",row.names = FALSE ) 
...
write.csv(mutnoncodel_shdi,"/Users/wanglu/Documents/2021_TC/final_version2/evaluating_indicator/tra_mutnoncodel_shdi.csv",row.names = FALSE )
