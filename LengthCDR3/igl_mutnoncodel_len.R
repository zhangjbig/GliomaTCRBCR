...
mutnoncodel <- data.frame(len = 0,prop = 0,CGGA_ID = 0)
...
mutnoncodel <- mutnoncodel[order(mutnoncodel$len),]
write.csv(mutnoncodel,"/Users/wanglu/Documents/2021_TC/final_version2/length/igl_mutnoncodel_len.csv",row.names = FALSE ) 
