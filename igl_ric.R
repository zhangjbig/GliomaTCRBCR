...
write.csv(wt_ric,"/Users/wanglu/Documents/2021_TC/final_version2/evaluating_indicator/igl_wt_ric.csv",row.names = TRUE ) 
...
write.csv(mutcodel_ric,"/Users/wanglu/Documents/2021_TC/final_version2/evaluating_indicator/igl_mutcodel_ric.csv",row.names = TRUE ) 
...
write.csv(mutnoncodel_ric,"/Users/wanglu/Documents/2021_TC/final_version2/evaluating_indicator/igl_mutnoncodel_ric.csv",row.names = TRUE ) 
